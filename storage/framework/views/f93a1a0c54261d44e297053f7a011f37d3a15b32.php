    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <?php echo e(Form::model($role, ['route' => ['role.update', encrypt($role->id)], 'method' => 'PUT'])); ?>

                    <div class="form-group">
                        <?php echo e(Form::label('title', __('Role Title'), ['class' => 'form-label'])); ?>

                        <?php echo e(Form::text('title', $role->name, ['class' => 'form-control', 'placeholder' => __('Enter role title'), in_array($role->name, ['tenant', 'maintainer']) ? 'readonly' : ''])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rentex/resources/views/role/edit.blade.php ENDPATH**/ ?>