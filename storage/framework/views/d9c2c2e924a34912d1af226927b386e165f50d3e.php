        ...
        <div class="container">
            <div class="cs_service_details">
                <div class="cs_banner cs_radius_50">
                    <img src="<?php echo e(asset('landing/assets/img/service_img-1.jpg')); ?>" alt="Service details banner">
                </div>
                ...
                <div class="row cs_row_gap_30 cs_gap_y_30 cs_mb_32">
                    <div class="col-md-6">
                        <div class="cs_radius_20">
                            <img src="<?php echo e(asset('landing/assets/img/service_img-2.jpg')); ?>" alt="Service image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="cs_radius_20">
                            <img src="<?php echo e(asset('landing/assets/img/service_img-3.jpg')); ?>" alt="Service image">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('landing.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rentex/resources/views/landing/service-details.blade.php ENDPATH**/ ?>