        ...
        <div class="container">
            <div class="row cs_gap_y_30 align-items-center">
                <div class="col-lg-6">
                    ...
                    <img src="<?php echo e(asset('landing/assets/img/icons/call.svg')); ?>" alt="Telephone icon">
                    </span>
                            ...
                            <li>
                                <div class="cs_iconbox cs_style_6">
                                    <span class="cs_iconbox_icon cs_center cs_radius_100 position-relative">
                    <img src="<?php echo e(asset('landing/assets/img/icons/email.svg')); ?>" alt="Email icon">
                    </span>
                                    <div class="cs_iconbox_info">
                            ...
                            <li>
                                <div class="cs_iconbox cs_style_6">
                                    <span class="cs_iconbox_icon cs_center cs_radius_100 position-relative">
                    <img src="<?php echo e(asset('landing/assets/img/icons/location.svg')); ?>" alt="Location icon">
                    </span>
                                    <div class="cs_iconbox_info">
                        ...
                        <a href="https://www.youtube.com/embed/HC-tgFdIcB0" aria-label="Click to play video" class="cs_video cs_style_1 cs_center cs_video_open cs_bg_filed position-relative" data-src="<?php echo e(asset('landing/assets/img/contact-img-1.jpg')); ?>">
...
<?php echo $__env->make('landing.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rentex/resources/views/landing/contact.blade.php ENDPATH**/ ?>