...
<footer class="cs_footer cs_style_1 cs_type_2 cs_accent_bg cs_bg_filed" data-src="<?php echo e(asset('landing/assets/img/footer-bg-3.svg')); ?>">
            ...
            <ul class="cs_location_list cs_mp_0">
                <li>
                    ...
                    <div class="cs_location_info cs_fs_18">
                        ...
                        <p class="cs_white_color mb-0"><?php echo nl2br(e($companyAddress)); ?></p>
                    </div>
                </li>
                <li>
                    <span class="cs_location_icon cs_center cs_heading_color cs_radius_100">
                    ...
                    <div class="cs_location_info cs_fs_18">
                        ...
                        <a href="mailto:<?php echo e($companyEmail); ?>" aria-label="Send mail link"><?php echo e($companyEmail); ?></a>
                    </div>
                </li>
                <li>
                    <span class="cs_location_icon cs_center cs_heading_color cs_radius_100">
                    ...
                    <div class="cs_location_info cs_fs_18">
                        ...
                        <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $companyPhone)); ?>" aria-label="Make a call link"><?php echo e($companyPhone); ?></a>
                    </div>
                </li>
            </ul>
        </div>
        <div class="cs_footer_main cs_radius_30">
            <div class="cs_footer_desc">
                ...
                <div class="cs_footer_desc_text">
                    <?php if(!empty($settings['company_description'])): ?>
                        <?php echo e($settings['company_description']); ?>
            ...
            <div class="cs_footer_header cs_radius_30">
                <ul class="cs_footer_menu cs_semibold cs_white_color cs_mp_0">
                    <li><a href="<?php echo e(url('/')); ?>" aria-label="Home page link">Home</a></li>
                    <li><a href="<?php echo e(route('landing.about')); ?>" aria-label="About page link">About Us</a></li>
                    <li><a href="<?php echo e(route('landing.services')); ?>" aria-label="Services page link">Services</a></li>
                    <li><a href="<?php echo e(route('landing.pricing')); ?>" aria-label="Pricing page link">Pricing</a></li>
                    <li><a href="<?php echo e(url('bloag')); ?>" aria-label="Blog page link">Blog</a></li>
                    <li><a href="<?php echo e(route('landing.contact')); ?>" aria-label="Contact page link">Contact Us</a></li>
                </ul>
                <div class="cs_social_links cs_style_1 cs_heading_color">
                    <?php if(!empty($settings['facebook_url'])): ?>
                        <a href="<?php echo e($settings['facebook_url']); ?>" target="_blank" aria-label="Social link"><i class="fa-brands fa-facebook-f"></i></a>
                    <?php endif; ?>
                    <?php if(!empty($settings['twitter_url'])): ?>
                        <a href="<?php echo e($settings['twitter_url']); ?>" target="_blank" aria-label="Social link"><i class="fa-brands fa-x-twitter"></i></a>
                    <?php endif; ?>
                    <?php if(!empty($settings['instagram_url'])): ?>
                        <a href="<?php echo e($settings['instagram_url']); ?>" target="_blank" aria-label="Social link"><i class="fa-brands fa-instagram"></i></a>
                    <?php endif; ?>
                    <?php if(!empty($settings['linkedin_url'])): ?>
                        <a href="<?php echo e($settings['linkedin_url']); ?>" target="_blank" aria-label="Social link"><i class="fa-brands fa-linkedin"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        <div class="cs_footer_bottom position-relative">
            <div class="cs_footer_text cs_white_color text-center">Copyright &copy; <span class="cs_getting_year"></span> <?php echo e($companyName); ?> — Smart Property Operations Software</div>
        </div>
    </div>
</footer>
<!-- End Footer Section -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rentex/resources/views/landing/partials/footer.blade.php ENDPATH**/ ?>