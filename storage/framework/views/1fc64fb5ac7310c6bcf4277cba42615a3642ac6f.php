...
<!-- Start Page Heading -->
    <section class="cs_page_heading cs_style_hero text-center position-relative">
        <div class="cs_page_heading_content cs_bg_filed cs_radius_50 position-relative z-1" data-src="<?php echo e(asset('landing/assets/img/page-heading-bg.svg')); ?>">
        <div class="container">
            ...
            <ol class="breadcrumb cs_fs_18 cs_heading_font">
                ...
                <div class="cs_hero_shape_1 position-absolute">
                    <img src="<?php echo e(asset('landing/assets/img/dna-shape.png')); ?>" alt="Shape">
                </div>
                <div class="cs_hero_shape_2 position-absolute">
                    <img src="<?php echo e(asset('landing/assets/img/spring-shape-3.svg')); ?>" alt="Shape">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row cs_gap_y_40">
                    <div class="col-lg-6 order-lg-2">
                        <div class="cs_card_thumbnail">
                            <img src="<?php echo e(asset('landing/assets/img/dashboard-2.png')); ?>" alt="Dashboard image">
                        </div>
                    </div>
                        ...
                        <div class="cs_card_content">
                            <div class="cs_section_heading cs_style_1 cs_mb_34">
                                <div class="cs_section_subtitle cs_fs_18 cs_heading_color cs_mb_22">
                                    <img src="<?php echo e(asset('landing/assets/img/icons/star-1.svg')); ?>" alt="Star icon">
                            ...
                            <div class="cs_btns_group">
                                <a href="<?php echo e(route('landing.contact')); ?>" aria-label="Get started button" class="cs_btn cs_style_1 cs_bg_1 cs_fs_14 cs_bold cs_white_color text-uppercase">
                  <span>Get Started Free</span>
                  <span class="cs_btn_icon"><i class="fa-solid fa-arrow-right"></i></span>
                  </a>
                                <div class="cs_client_info_wrapper">
                                    <img src="<?php echo e(asset('landing/assets/img/customers-group.png')); ?>" alt="Customers image">
                                    <div>
    ...
    <section class="cs_customer_review cs_bg_filed cs_radius_50" data-src="<?php echo e(asset('landing/assets/img/rating-bg-1.svg')); ?>">
        <div class="container">
            ...
            <div class="row cs_row_gap_30 cs_gap_y_30">
                <div class="col-lg-4">
                    <div class="cs_review_item cs_center_column cs_radius_20 text-center">
                        ...
                        <img src="<?php echo e(asset('landing/assets/img/rating-logo-1.svg')); ?>" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="cs_review_item cs_center_column cs_radius_20 text-center">
                        ...
                        <img src="<?php echo e(asset('landing/assets/img/rating-logo-2.svg')); ?>" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="cs_review_item cs_center_column cs_radius_20 text-center">
                        ...
                        <p class="cs_fs_20 cs_white_color cs_mb_33">"The Interface Is Excellent"</p>
                        <img src="<?php echo e(asset('landing/assets/img/rating-logo-3.svg')); ?>" alt="Logo">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row cs_gap_y_50 position-relative z-1">
                    <div class="col-lg-6">
                        <div class="cs_card_thumbnail position-relative">
                            <img src="<?php echo e(asset('landing/assets/img/dashboard.png')); ?>" alt="Dashboard image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="cs_card_content">
                    ...
                    <img src="<?php echo e(asset('landing/assets/img/icons/advanced-tracking.svg')); ?>" alt="Advanced tracking icon">
                    </span>
                    ...
                    <img src="<?php echo e(asset('landing/assets/img/icons/in-depth.svg')); ?>" alt="In-depth monitoring icon">
                    </span>
                                    <div class="cs_iconbox_info">
    ...
    <div class="cs_counter cs_style_1 cs_type_1 cs_accent_bg" data-src="<?php echo e(asset('landing/assets/img/counter-bg-2.svg')); ?>">
        <div class="container">
            ...
            <div class="cs_card cs_style_1 cs_type_5">
                <div class="row cs_gap_y_30">
                    <div class="col-lg-5 order-lg-2">
                        <a href="https://www.youtube.com/embed/HC-tgFdIcB0" aria-label="Click to play video" class="cs_video cs_style_1 cs_center cs_video_open cs_bg_filed cs_radius_15 position-relative" data-src="<?php echo e(asset('landing/assets/img/video-bg-1.jpg')); ?>">
                ...
                <div class="cs_vector_shape_5 position-absolute">
                  <img src="<?php echo e(asset('landing/assets/img/vector-10.svg')); ?>" alt="Vector shape">
                </div>
              </a>
                    </div>
                  ...
                  <span class="cs_btn_icon"><i class="fa-solid fa-arrow-right"></i></span>
                                ...
                                <div class="cs_client_info_wrapper">
                                    <img src="<?php echo e(asset('landing/assets/img/customers-group-2.png')); ?>" alt="Customers image">
                                    <div>
        ...
        <div class="container">
            <div class="cs_testimonial_slider_wrapper cs_radius_20 position-relative">
                ...
                <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-variable-width="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="1" data-md-slides="1" data-lg-slides="1" data-add-slides="1">
                    ...
                    <img src="<?php echo e(asset('landing/assets/img/icons/qote.svg')); ?>" alt="Quote icon">
                    </span>
                    ...
                    <img src="<?php echo e(asset('landing/assets/img/avatar-5.jpg')); ?>" alt="Avatar">
                    </span>
                    ...
                    <img src="<?php echo e(asset('landing/assets/img/icons/qote.svg')); ?>" alt="Quote icon">
                                ...
                                <div class="cs_avatar cs_style_1">
                                    <span class="cs_avatar_icon cs_center cs_radius_100">
                    <img src="<?php echo e(asset('landing/assets/img/avatar-6.jpg')); ?>" alt="Avatar">
                    </span>
                                    <div class="cs_avatar_info">
            ...
            <div class="row cs_row_gap_30 cs_gap_y_30 justify-content-center">
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1">
                        <a href="<?php echo e(route('landing.team-details')); ?>" class="cs_team_thumbnail cs_radius_100 cs_center position-relative z-1">
              <img src="<?php echo e(asset('landing/assets/img/team-img-1.jpg')); ?>" alt="Team image">
              </a>
                        <div class="cs_team_info cs_radius_30 cs_white_bg cs_center_column text-center">
                            <h3 class="cs_team_title cs_fs_24 cs_semibold cs_mb_4"><a href="<?php echo e(route('landing.team-details')); ?>">Miler Michel</a></h3>
                ...
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1">
                        <a href="<?php echo e(route('landing.team-details')); ?>" class="cs_team_thumbnail cs_radius_100 cs_center position-relative z-1">
              <img src="<?php echo e(asset('landing/assets/img/team-img-2.jpg')); ?>" alt="Team image">
              </a>
                        <div class="cs_team_info cs_radius_30 cs_white_bg cs_center_column text-center">
                            <h3 class="cs_team_title cs_fs_24 cs_semibold cs_mb_4"><a href="<?php echo e(route('landing.team-details')); ?>">Olivia Martinez</a></h3>
                            <p class="cs_fs_18 cs_heading_color cs_mb_12">co-Founder</p>
                            <div class="cs_social_links cs_style_1">
                                <a href="#" aria-label="Social link"><i class="fa-brands fa-facebook-f"></i></a>
                                <a href="#" aria-label="Social link"><i class="fa-brands fa-twitter"></i></a>
                ...
                <div class="col-lg-4">
                    <div class="cs_team cs_style_1">
                        <a href="<?php echo e(route('landing.team-details')); ?>" class="cs_team_thumbnail cs_radius_100 cs_center position-relative z-1">
              <img src="<?php echo e(asset('landing/assets/img/team-img-3.jpg')); ?>" alt="Team image">
              </a>
                        <div class="cs_team_info cs_radius_30 cs_white_bg cs_center_column text-center">
                            <h3 class="cs_team_title cs_fs_24 cs_semibold cs_mb_4"><a href="<?php echo e(route('landing.team-details')); ?>">Scarlett Adams</a></h3>
...
<?php echo $__env->make('landing.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rentex/resources/views/landing/about-us.blade.php ENDPATH**/ ?>