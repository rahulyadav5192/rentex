    ...
    <section class="position-relative">
        ...
        <div class="container">
            <div class="cs_features_items_wrapper position-relative z-1">
                <div class="cs_feature_item cs_radius_20 cs_bg_filed" data-src="<?php echo e(asset('landing/assets/img/feature-item-bg.svg')); ?>">
                    <h3 class="cs_fs_36 cs_semibold cs_white_color cs_mb_40">See more and get visibility <br> for your business</h3>
                    <a href="<?php echo e(route('landing.contact')); ?>" aria-label="Get started button" class="cs_btn cs_style_1 cs_fs_14 cs_bold cs_white_color text-uppercase">
            ...
            <img src="<?php echo e(asset('landing/assets/img/icons/code-icon.svg')); ?>" alt="Coding icon">
            </span>
                    <h3 class="cs_fs_24 cs_semibold cs_mb_6">
                        <a href="<?php echo e(route('landing.service-details')); ?>" aria-label="Service details link">Software Development</a>
                    </h3>
                    <ul class="cs_features_list cs_mp_0">
                        <li>
                            <img src="<?php echo e(asset('landing/assets/img/icons/caret-icon.svg')); ?>" alt="Caret icon">
                            <span>Security</span>
                        </li>
                        <li>
                            <img src="<?php echo e(asset('landing/assets/img/icons/caret-icon.svg')); ?>" alt="Caret icon">
                    ...
                    <a href="<?php echo e(route('landing.service-details')); ?>" aria-label="Service details link" class="cs_text_btn cs_fs_14 cs_bold text-uppercase">
            <span>Read More</span>
            <span class="cs_btn_icon"><i class="fa-solid fa-arrow-right"></i></span>
            </a>
                </div>
            ...
            <img src="<?php echo e(asset('landing/assets/img/icons/cloud-computing.svg')); ?>" alt="Cloud computing icon">
            </span>
                    <h3 class="cs_fs_24 cs_semibold cs_mb_6">
                        <a href="<?php echo e(route('landing.service-details')); ?>" aria-label="Service details link">Cloud Computing Solutions</a>
                    </h3>
                    <ul class="cs_features_list cs_mp_0">
                        <li>
                            <img src="<?php echo e(asset('landing/assets/img/icons/caret-icon.svg')); ?>" alt="Caret icon">
            ...
            <img src="<?php echo e(asset('landing/assets/img/icons/quality-assurance.svg')); ?>" alt="Quality assurance icon">
            </span>
                    <h3 class="cs_fs_24 cs_semibold cs_mb_6">
                        <a href="<?php echo e(route('landing.service-details')); ?>" aria-label="Service details link">Quality Assurance</a>
                    </h3>
                    <ul class="cs_features_list cs_mp_0">
                        <li>
                            <img src="<?php echo e(asset('landing/assets/img/icons/caret-icon.svg')); ?>" alt="Caret icon">
            ...
            <img src="<?php echo e(asset('landing/assets/img/icons/security.svg')); ?>" alt="Cybersecurity security icon">
            </span>
                    <h3 class="cs_fs_24 cs_semibold cs_mb_6">
                        <a href="<?php echo e(route('landing.service-details')); ?>" aria-label="Service details link">Cybersecurity Services</a>
                    </h3>
                    <ul class="cs_features_list cs_mp_0">
                        <li>
                            <img src="<?php echo e(asset('landing/assets/img/icons/caret-icon.svg')); ?>" alt="Caret icon">
            ...
            <div class="cs_features_steps_wrapper">
                <div class="cs_feature_step cs_center_column">
                    ...
                    <div class="cs_step_indfo_wrapper cs_radius_30 text-center position-relative">
                        ...
                        <img src="<?php echo e(asset('landing/assets/img/border-shape.png')); ?>" alt="Border shape">
                    </div>
                </div>
                <div class="cs_feature_step cs_center_column">
...
<?php echo $__env->make('landing.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rentex/resources/views/landing/services.blade.php ENDPATH**/ ?>