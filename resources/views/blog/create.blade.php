{{Form::open(array('url'=>'blog','method'=>'post', 'enctype' => 'multipart/form-data', 'id' => 'blog-form'))}}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::file('image', ['class' => 'form-control', 'accept' => 'image/*', 'required' => 'required']) }}
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('author', \Auth::user()->name, ['class' => 'form-control', 'placeholder' => __('Author Name')]) }}
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="form-check form-switch">
                {{ Form::checkbox('enabled', 1, true, ['class' => 'form-check-input', 'role' => 'switch', 'id' => 'enabled']) }}
