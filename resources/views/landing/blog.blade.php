...
<!-- Start Page Heading -->
  ...
  <path d="M0 10L1.7625 11.7625L8.75 4.7875V20H11.25V4.7875L18.225 11.775L20 10L10 0L0 10Z" fill="currentColor" />
    ...
    <section class="cs_page_heading cs_bg_filed text-center cs_gray_bg_2 position-relative overflow-hidden" data-src="{{ asset('landing/assets/img/page-heading-bg.svg') }}">
        <div class="container">
            <h1 class="cs_fs_64 cs_bold cs_mb_8">Blog Standard</h1>
            <ol class="breadcrumb cs_fs_18 cs_heading_font">
                <li class="breadcrumb-item"><a aria-label="Back to home page link" href="/">Home</a></li>
    ...
    <div class="container">
        <div class="row cs_row_gap_30 cs_gap_y_60">
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="cs_posts_wrapper">
                    <article class="cs_post cs_style_1 cs_type_2 cs_radius_16">
                        <a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link" class="cs_post_thumbnail cs_radius_10 cs_mb_28 position-relative overflow-hidden">
                <img src="{{ asset('landing/assets/img/post-img-16.jpg') }}" alt="Post image">
                <div class="cs_posted_by cs_center_column cs_heading_font cs_white_color cs_radius_8 position-absolute">
                  <span class="cs_fs_24 cs_bold cs_mb_2">15</span>
                  <span class="cs_fs_14">Feb</span>
                </div>
              </a>
                        <div class="cs_post_content">
                            <div class="cs_post_meta_wrapper cs_mb_10">
                            ...
                            <h3 class="cs_post_title cs_fs_30 cs_semibold cs_mb_7"><a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link">Choose The Best Service Company in the City.</a></h3>
                            <p class="cs_post_subtitle cs_heading_font cs_mb_21">Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum mauris id nunc molestie tincidunt erat gravida. Nullam dui
                                libero, mollis ac quam et, venenatis.</p>
                            <a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link" class="cs_btn cs_style_1 cs_bg_1 cs_fs_14 cs_semibold cs_heading_font cs_white_color">
                <span>Read More</span>
                <span class="cs_btn_icon"><i class="fa-solid fa-arrow-right"></i></span>
                    ...
                    <article class="cs_post cs_style_1 cs_type_2 cs_radius_16">
                        <a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link" class="cs_post_thumbnail cs_radius_10 cs_mb_28 position-relative overflow-hidden">
                <img src="{{ asset('landing/assets/img/post-img-17.jpg') }}" alt="Post image">
                <div class="cs_posted_by cs_center_column cs_heading_font cs_white_color cs_radius_8 position-absolute">
                  <span class="cs_fs_24 cs_bold cs_mb_2">27</span>
                  <span class="cs_fs_14">Feb</span>
                </div>
              </a>
                        <div class="cs_post_content">
                            ...
                            <h3 class="cs_post_title cs_fs_30 cs_semibold cs_mb_7"><a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link">Keep Your Business Ensure High Availability</a></h3>
                            <p class="cs_post_subtitle cs_heading_font cs_mb_21">Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum mauris id nunc molestie tincidunt erat gravida. Nullam dui
                                libero, mollis ac quam et, venenatis.</p>
                            <a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link" class="cs_btn cs_style_1 cs_bg_1 cs_fs_14 cs_semibold cs_heading_font cs_white_color">
                <span>Read More</span>
                <span class="cs_btn_icon"><i class="fa-solid fa-arrow-right"></i></span>
                    ...
                    <article class="cs_post cs_style_1 cs_type_2 cs_radius_16">
                        <a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link" class="cs_post_thumbnail cs_radius_10 cs_mb_28 position-relative overflow-hidden">
                <img src="{{ asset('landing/assets/img/post-img-18.jpg') }}" alt="Post image">
                <div class="cs_posted_by cs_center_column cs_heading_font cs_white_color cs_radius_8 position-absolute">
                  <span class="cs_fs_24 cs_bold cs_mb_2">20</span>
                  <span class="cs_fs_14">Feb</span>
                </div>
              </a>
                        <div class="cs_post_content">
                            ...
                            <h3 class="cs_post_title cs_fs_30 cs_semibold cs_mb_7"><a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link">Tackling the Changes of Retell Industry</a></h3>
                            <p class="cs_post_subtitle cs_heading_font cs_mb_21">Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum mauris id nunc molestie tincidunt erat gravida. Nullam dui
                                libero, mollis ac quam et, venenatis.</p>
                            <a href="{{ route('landing.blog-details') }}" aria-label="Reading details post link" class="cs_btn cs_style_1 cs_bg_1 cs_fs_14 cs_semibold cs_heading_font cs_white_color">
                <span>Read More</span>
                ...
                <div class="cs_height_60 cs_height_lg_50"></div>
                <ul class="pagination cs_heading_font cs_mp_0 justify-content-start">
                    <li class="page-item"><a class="page-link" href="#">Previous</a></li>
                    <li class="page-item active"><a class="page-link" href="#">1</a></li>
                    <li class="page-item"><a class="page-link" href="#">2</a></li>
                    <li class="page-item"><a class="page-link" href="#">3</a></li>
