...
<head>
    ...
    @endphp
    <link href="{{ $faviconUrl }}" sizes="128x128" rel="shortcut icon" type="image/x-icon" />
    <link href="{{ $faviconUrl }}" sizes="128x128" rel="shortcut icon" />
    <!-- Apple Touch Icon -->
    <link href="{{ $faviconUrl }}" sizes="60x60" rel="apple-touch-icon">
    <link href="{{ $faviconUrl }}" sizes="72x72" rel="apple-touch-icon">
    <link href="{{ $faviconUrl }}" sizes="114x114" rel="apple-touch-icon">
    <link href="{{ $faviconUrl }}" sizes="180x180" rel="apple-touch-icon">
