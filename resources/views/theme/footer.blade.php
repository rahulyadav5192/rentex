            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-12">
                    <div class="lg:col-span-4 space-y-6">
                        <a class="flex items-center space-x-2" href="{{ route('web.page', $user->code) }}">
                            @if (!empty($logoUrl) && $logoUrl != asset('logo.png'))
                                <img src="{{ $logoUrl }}" alt="{{ $appName }}" class="h-10 w-auto max-w-[180px] object-contain" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                            @endif
                            <div class="flex items-center gap-2" style="{{ !empty($logoUrl) && $logoUrl != asset('logo.png') ? 'display: none;' : '' }}">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <h4 class="text-sm font-semibold text-white uppercase tracking-wider">{{ __('Quick Links') }}</h4>
                        <ul class="space-y-3 text-sm">
                            <li><a class="hover:text-primary transition-colors duration-200" href="{{ route('web.page', $user->code) }}">{{ __('Home') }}</a></li>
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <h4 class="text-sm font-semibold text-white uppercase tracking-wider">{{ __('About') }}</h4>
                        <ul class="space-y-3 text-sm">
                            <li><a class="hover:text-primary transition-colors duration-200" href="{{ route('web.page', $user->code) }}#features">{{ __('Features') }}</a></li>
                            <li><a class="hover:text-primary transition-colors duration-200" href="{{ route('web.page', $user->code) }}#about">{{ __('About Us') }}</a></li>
                            <li><a class="hover:text-primary transition-colors duration-200" href="{{ route('blog.home', ['code' => $user->code]) }}">{{ __('Blog') }}</a></li>
                            <li><a class="hover:text-primary transition-colors duration-200" href="{{ route('contact.home', ['code' => $user->code]) }}">{{ __('Contact Us') }}</a></li>
                        </ul>
                    </div>
                    @php
                        ...
                        <div class="lg:col-span-2 space-y-4">
                            ...
                            <div class="flex flex-wrap gap-3">
                                @if (!empty($Section_8_content_value['fb_link']) && $Section_8_content_value['fb_link'] !== '#')
                                    <a aria-label="Facebook" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 shadow-sm" href="{{ $Section_8_content_value['fb_link'] }}" target="_blank" rel="noopener noreferrer">
                                ...
                                @if (!empty($Section_8_content_value['twitter_link']) && $Section_8_content_value['twitter_link'] !== '#')
                                    <a aria-label="Twitter" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 shadow-sm" href="{{ $Section_8_content_value['twitter_link'] }}" target="_blank" rel="noopener noreferrer">
                                ...
                                @if (!empty($Section_8_content_value['insta_link']) && $Section_8_content_value['insta_link'] !== '#')
                                    <a aria-label="Instagram" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 shadow-sm" href="{{ $Section_8_content_value['insta_link'] }}" target="_blank" rel="noopener noreferrer">
                                ...
                                @if (!empty($Section_8_content_value['linkedin_link']) && $Section_8_content_value['linkedin_link'] !== '#')
                                    <a aria-label="LinkedIn" class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-all duration-300 shadow-sm" href="{{ $Section_8_content_value['linkedin_link'] }}" target="_blank" rel="noopener noreferrer">
                ...
                <div class="pt-8 mt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
                    ...
                    <div class="flex items-center space-x-6 mt-4 md:mt-0">
                        <a class="hover:text-gray-300 transition-colors" href="{{ $saasUrl }}" target="_blank" rel="noopener noreferrer">
                            {{ __('Powered by') }} <span class="font-semibold text-light">xOwner</span>
                        </a>
                    </div>
                </div>
            </div>
