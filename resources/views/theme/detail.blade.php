                    ...
                    @if ($allImages->count() > 1)
                        <div id="thumbnailGallery" class="flex gap-2 sm:gap-4 mt-4 overflow-x-auto pb-2 scrollbar-hide">
                            @foreach ($allImages as $index => $img)
                                <button onclick="changeMainImage('{{ $img['image'] }}', this, {{ $index }})" 
                                        class="thumbnail-btn relative flex-none w-20 h-14 sm:w-24 sm:h-16 rounded-lg overflow-hidden {{ $index === 0 ? 'ring-2 ring-primary ring-offset-2 dark:ring-offset-gray-900 opacity-100' : 'opacity-70 hover:opacity-100' }} hover:ring-2 hover:ring-primary/50 transition-all">
                                    <img alt="{{ $img['alt'] }}" 
                ...
                <div class="lg:hidden space-y-6">
                    ...
                    <div class="bg-card-light dark:bg-card-dark rounded-xl p-5 sm:p-6 shadow-soft-hover dark:shadow-none dark:border dark:border-border-dark">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h1 class="text-xl sm:text-2xl font-display font-bold text-text-main-light dark:text-text-main-dark mb-1">{{ ucfirst($property->name) }}</h1>
                        ...
                        <div class="my-4 sm:my-6 pt-4 sm:pt-6 border-t border-gray-100 dark:border-gray-700">
                            <p class="text-xs sm:text-sm font-medium text-text-sub-light dark:text-text-sub-dark uppercase tracking-wide">{{ $priceLabel }}</p>
                            <div class="flex items-baseline gap-1">
                                <span class="text-2xl sm:text-3xl font-bold text-primary">{{ $priceDisplay }}</span>
                            </div>
                        </div>
    ...
    @endif
                    ...
                    @if ($units->count() > 0)
                        <div class="bg-card-light dark:bg-card-dark rounded-xl p-4 sm:p-6 shadow-soft dark:shadow-none dark:border dark:border-border-dark">
                            <h2 class="text-lg sm:text-xl font-display font-bold mb-3 sm:mb-6 text-text-main-light dark:text-text-main-dark">{{ __('Property Unit Specification') }}</h2>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
                                <div class="group bg-gray-50 dark:bg-gray-800 p-3 sm:p-5 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-md transition duration-300">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-xs sm:text-sm text-text-sub-light dark:text-text-sub-dark font-medium">{{ __('Bedrooms') }}</span>
                                    ...
                                    <p class="text-2xl sm:text-3xl font-display font-bold text-text-main-light dark:text-text-main-dark group-hover:text-primary transition-colors">{{ $totalBedrooms }}</p>
                                    <p class="text-xs text-text-sub-light dark:text-text-sub-dark mt-1">{{ __('Total Rooms') }}</p>
                                </div>
                                <div class="group bg-gray-50 dark:bg-gray-800 p-3 sm:p-5 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-md transition duration-300">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-xs sm:text-sm text-text-sub-light dark:text-text-sub-dark font-medium">{{ __('Kitchens') }}</span>
                                    ...
                                    <p class="text-2xl sm:text-3xl font-display font-bold text-text-main-light dark:text-text-main-dark group-hover:text-primary transition-colors">{{ $totalKitchens }}</p>
                                    <p class="text-xs text-text-sub-light dark:text-text-sub-dark mt-1">{{ __('Fully Equipped') }}</p>
                                </div>
                                <div class="group bg-gray-50 dark:bg-gray-800 p-3 sm:p-5 rounded-xl border border-gray-100 dark:border-gray-700 hover:shadow-md transition duration-300">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-xs sm:text-sm text-text-sub-light dark:text-text-sub-dark font-medium">{{ __('Bathrooms') }}</span>
                                    ...
                                    <p class="text-2xl sm:text-3xl font-display font-bold text-text-main-light dark:text-text-main-dark group-hover:text-primary transition-colors">{{ $totalBathrooms }}</p>
