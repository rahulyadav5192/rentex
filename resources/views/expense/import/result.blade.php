...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('expense.index') }}">{{ __('Tenant') }}</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                @php
                    $expensesCreated = $importResult['expenses_created'] ?? 0;
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center">
                                <h2 class="text-success mb-2">{{ $expensesCreated }}</h2>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-2">
                            @foreach($skipReasons as $reason)
                                <li>{{ __('Row') }} {{ $reason['row'] }} - {{ $reason['expense'] }}: {{ $reason['reason'] }}</li>
                            @endforeach
                        </ul>
                    </div>
                @endif
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="{{ route('expense.import.index') }}" class="btn btn-secondary">
